...
{
    public class PreparedProductConfiguration : IEntityTypeConfiguration<PreparedProduct>
    {
        public void Configure(EntityTypeBuilder<PreparedProduct> entity)
        {
            ...
            entity.HasMany(o => o.Batches).WithOne().HasForeignKey(c => c.PreparedProductId)
                .OnDelete(DeleteBehavior.Cascade);

            entity.HasKey(c => c.Id);
            entity.ToTable("PreparedProducts");
        }
    }
}