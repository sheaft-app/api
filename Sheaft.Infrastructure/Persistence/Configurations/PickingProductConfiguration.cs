...
{
    public class PickingProductConfiguration : IEntityTypeConfiguration<PickingProduct>
    {
        public void Configure(EntityTypeBuilder<PickingProduct> entity)
        {
            ...
            entity.ToTable("PickingProducts");
        }
    }
}