...
namespace Sheaft.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20211007114614_UnmappedVatPriceAndOnSalePrice")]
    partial class UnmappedVatPriceAndOnSalePrice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sheaft.Domain.Batch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProducerId", "Number")
                        .IsUnique();

                    b.ToTable("Batches");
                });

            modelBuilder.Entity("Sheaft.Domain.BatchDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sheaft.Domain.Delivery", b =>
                {
                    ...
                    b.Property<int>("BrokenProductsCount")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("DeliveryFeesOnSalePrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DeliveryFeesVatPrice")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("ExcessProductsCount")
                        .HasColumnType("int");

                    b.Property<int>("ImproperProductsCount")
                        .HasColumnType("int");

                    b.Property<int>("Kind")
                        .HasColumnType("int");

                    b.Property<int>("MissingProductsCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProductsDeliveredCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sheaft.Domain.DeliveryProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sheaft.Domain.ObservationBatch", b =>
                {
                    ...
                    b.HasKey("BatchId", "ObservationId");

                    b.HasIndex("ObservationId");

                    b.ToTable("ObservationBatches");
                });

            modelBuilder.Entity("Sheaft.Domain.ObservationProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sheaft.Domain.PreparedProductBatch", b =>
                {
                    b.Property<Guid>("BatchId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PreparedProductId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset>("CreatedOn")
                        .HasColumnType("datetimeoffset");

                    b.HasKey("BatchId", "PreparedProductId");

                    b.HasIndex("PreparedProductId");

                    b.ToTable("PreparedProductBatchs");
                });
            ...
            modelBuilder.Entity("Sheaft.Domain.RecallBatch", b =>
                {
                    b.Property<Guid>("BatchId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sheaft.Domain.Batch", b =>
                {
                    b.HasOne("Sheaft.Domain.BatchDefinition", "Definition")
                        .WithMany()
            ...
            modelBuilder.Entity("Sheaft.Domain.ObservationBatch", b =>
                {
                    b.HasOne("Sheaft.Domain.Batch", "Batch")
                        .WithMany()
            ...
            modelBuilder.Entity("Sheaft.Domain.PreparedProductBatch", b =>
                {
                    ...
                    b.HasOne("Sheaft.Domain.PreparedProduct", null)
                        .WithMany("Batches")
                        .HasForeignKey("PreparedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sheaft.Domain.PurchaseOrder", b =>
                {
                    b.HasOne("Sheaft.Domain.Delivery", "Delivery")
                    ...
                    b.OwnsOne("Sheaft.Domain.ExpectedPurchaseOrderDelivery", "ExpectedDelivery", b1 =>
                        {
                            ...
                            b1.Property<decimal>("DeliveryFeesOnSalePrice")
                                .HasColumnType("decimal(18,2)");

                            b1.Property<decimal>("DeliveryFeesVatPrice")
                                .HasColumnType("decimal(18,2)");
