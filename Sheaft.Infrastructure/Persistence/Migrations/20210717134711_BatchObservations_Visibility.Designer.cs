...
namespace Sheaft.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210717134711_BatchObservations_Visibility")]
    partial class BatchObservations_Visibility
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sheaft.Domain.BatchObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sheaft.Domain.BatchObservation", b =>
                {
                    b.HasOne("Sheaft.Domain.Batch", null)
                        .WithMany("Observations")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sheaft.Domain.BatchObservation", null)
                        .WithMany("Replies")
