...
namespace Sheaft.Infrastructure.Migrations
{
    public partial class InitDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData("Users", new List<string>() { "Uid", "Id", "CreatedOn", "Email", "FirstName", "LastName", "CompanyUid", "Anonymous" }.ToArray(), new List<object>() { 1, "28491432-1754-4285-9F67-5386A898A48F", "2020-01-30 22:45:41", "contact@biocoop-semnoz.xyz", "Semnoz", "Biocoop", 2, false }.ToArray(), "dbo");
            migrationBuilder.InsertData("Users", new List<string>() { "Uid", "Id", "CreatedOn", "Email", "FirstName", "LastName", "CompanyUid", "Anonymous" }.ToArray(), new List<object>() { 2, "5A8F0AE2-B701-47F0-A8EF-E7C2365A72EB", "2020-01-25 15:23:10", "contact@lfdp.xyz", "La Ferme du Parquet", "GAEC", 1, false }.ToArray(), "dbo");
            migrationBuilder.InsertData("Users", new List<string>() { "Uid", "Id", "CreatedOn", "Email", "FirstName", "LastName", "CompanyUid", "Anonymous" }.ToArray(), new List<object>() { 3, "0EAFD299-D0E6-4A63-AF8D-6D154DB96F55", "2020-01-25 15:23:10", "contact@biocoop-orky.xyz", "Orky", "Biocoop", 3, false }.ToArray(), "dbo");
            migrationBuilder.InsertData("Users", new List<string>() { "Uid", "Id", "CreatedOn", "Email", "FirstName", "LastName", "CompanyUid", "Anonymous" }.ToArray(), new List<object>() { 4, "442E31E3-EEA9-4AA0-B741-3245ED1C6F2F", "2020-01-25 15:23:10", "contact@lfdcj.xyz", "La Ferme du Crêt Joli", "GAEC", 4, false }.ToArray(), "dbo");
