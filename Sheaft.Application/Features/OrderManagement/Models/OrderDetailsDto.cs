...
public record OrderDetailsDto(string Id, string Code, OrderStatus Status, decimal TotalWholeSalePrice,
    ...
    OrderUserDto Supplier, OrderUserDto Customer, IEnumerable<OrderLineDto> Lines, OrderDeliveryDto Delivery, bool CanAcceptOrRefuse, bool CanCancel, bool CanFulfill, bool CanComplete, bool CanInvoice, string? InvoiceId, string Reason);