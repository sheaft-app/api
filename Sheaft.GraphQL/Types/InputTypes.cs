...
namespace Sheaft.GraphQL.Types
{
    ...
    public class RegisterCompanyInputType : SheaftInputType<RegisterCompanyInput>
    {
        protected override void Configure(IInputObjectTypeDescriptor<RegisterCompanyInput> descriptor)
        {
    ...
    public class UpdateCompanyInputType : SheaftInputType<UpdateCompanyInput>
    {
        protected override void Configure(IInputObjectTypeDescriptor<UpdateCompanyInput> descriptor)
        {
            descriptor.Field(c => c.AppearInBusinessSearchResults);
            descriptor.Field(c => c.Description);
            descriptor.Field(c => c.OpeningHours);
    ...
    public class UpdateUserInputType : SheaftInputType<UpdateUserInput>
    {
