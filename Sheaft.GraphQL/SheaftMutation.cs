...
namespace Sheaft.GraphQL.Services
{
    public class SheaftMutation
    {
        ...
        public async Task<IQueryable<StoreDto>> RegisterStoreAsync(RegisterStoreInput input, [Service] IStoreQueries storeQueries)
        {
        ...
        public async Task<IQueryable<StoreDto>> UpdateStoreAsync(UpdateStoreInput input, [Service] IStoreQueries storeQueries)
        {
        ...
        public async Task<IQueryable<ProducerDto>> RegisterProducerAsync(RegisterProducerInput input, [Service] IProducerQueries producerQueries)
        {
        ...
        public async Task<IQueryable<ProducerDto>> UpdateProducerAsync(UpdateProducerInput input, [Service] IProducerQueries producerQueries)
        {
