...
namespace Sheaft.Services.Store.Queries
{
    public class StoreQueries : IStoreQueries
    {
        ...
        public async Task<StoresSearchDto> SearchStoresAsync(Guid producerId, SearchTermsDto terms, RequestUser currentUser, CancellationToken token)
        {
