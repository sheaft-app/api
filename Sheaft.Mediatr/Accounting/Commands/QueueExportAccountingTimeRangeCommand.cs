...
{
    public class QueueExportAccountingTimeRangeCommand : Command<Guid>
    {
        protected QueueExportAccountingTimeRangeCommand()
        {
        }

        [JsonConstructor]
        public QueueExportAccountingTimeRangeCommand(RequestUser requestUser) : base(requestUser)
        {
    ...
    public class QueueExportAccountingTimeRangeCommandHandler : CommandsHandler,
        IRequestHandler<QueueExportAccountingTimeRangeCommand, Result<Guid>>
    {
        ...
        public async Task<Result<Guid>> Handle(QueueExportAccountingTimeRangeCommand request, CancellationToken token)
        {
            ...
            var command = new ExportAccountingTimeRangeCommand(request.RequestUser)
                {JobId = Guid.NewGuid(), From = request.From, To = request.To, Kinds = request.Kinds};

            var entity = new Domain.Job(command.JobId, JobKind.ExportUserAccountingTimeRange,
