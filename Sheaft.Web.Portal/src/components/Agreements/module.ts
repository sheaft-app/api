...
import { ListSentAgreementsHandler, ListSentAgreementsQuery } from '$components/Agreements/queries/listSentAgreements'
import {
  ListReceivedAgreementsHandler,
  ListReceivedAgreementsQuery
} from '$components/Agreements/queries/listReceivedAgreements'
import { GetAgreementHandler, GetAgreementQuery } from '$components/Agreements/queries/getAgreement'
