...
import type { CreateReturnableForm, UpdateReturnableForm } from '$components/Returnables/types'

export const suite = create('returnable-suite', (data: CreateReturnableForm|UpdateReturnableForm) => {
