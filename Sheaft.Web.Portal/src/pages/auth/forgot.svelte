      ...
      <div class='md:w-8/12 lg:w-5/12 lg:ml-20'>
        ...
        {#if !resetRequested}
          <form class=''>
            ...
            <Submit on:click='{() => forgot()}' className='block w-full mt-6'>Reinitialiser</Submit>
          </form>
        {:else}
          <div class='items-center justify-center'>
            <Fa icon='{faCheck}' scale={5} class='text-emerald-600 icon pulse w-full'/>
            <div class=' text-center'>
            <p class='w-full mt-16 mb-4'>Votre demande de réinitialisation de mot de passe a bien été prise en compte.</p>
