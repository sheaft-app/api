  ...
  <div class='container px-6 py-12 h-full'>
    <div class='flex justify-center items-center flex-wrap h-full g-6 text-gray-800'>
      ...
      <div class='md:w-8/12 lg:w-5/12 lg:ml-20'>
        ...
        <form>
          <Password bind:value='{newPassword}' placeholder='Votre nouveau mot de passe' class='mb-6 w-full' />
          <Password bind:value='{confirmPassword}' placeholder='Confirmer le nouveau mot de passe' class='mb-6 w-full' />
          <Submit on:click='{() => reset(code, newPassword, confirmPassword)}' class='block w-full mt-6'>Enregistrer</Submit>
        </form>
      </div>
    </div>
  </div>
