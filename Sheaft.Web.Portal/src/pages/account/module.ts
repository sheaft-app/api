...
import { RefreshAccessTokenRequest, RefreshAccessTokenRequestHandler } from '$commands/account/refreshAccessToken'
import { RegisterRequest, RegisterRequestHandler } from '$commands/account/register'
import { ForgotPasswordRequest, ForgotPasswordRequestHandler } from '$commands/account/forgotPassword'
import { ResetPasswordRequest, ResetPasswordRequestHandler } from '$commands/account/resetPassword'
import { LogoutRequest, LogoutRequestHandler } from '$commands/account/logout'
import { ConfigureAccountRequest, ConfigureAccountRequestHandler } from '$commands/account/configureAccount'
...
export const initAccountModule = (client: Client, authStore:IAuthStore): IAccountModule => {
  if (module)
    return module
